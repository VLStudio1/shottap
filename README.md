...
The `dist/` folder is generated during release builds and is intentionally not stored in the source repository. Published EXEs live on the release page so the code stays lightweight.
